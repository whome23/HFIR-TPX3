...
public:
  ...
  unsigned long int getABSMinClusterSize() 
    ...
    unsigned long int getABSMaxClusterSize() 
        const {return m_abs_max_cluster_size;};
...
private:
  ...
  unsigned long int m_abs_max_cluster_size;
