...
class ABS : public ClusteringAlgorithm {
 public:
  ABS(double r, unsigned long int min_cluster_size,unsigned long int max_cluster_size,
      unsigned long int spider_time_range) : 
      m_feature(r), m_min_cluster_size(min_cluster_size),m_max_cluster_size(max_cluster_size), spiderTimeRange_(spider_time_range) {};
 ...
 private:
  ...
  unsigned long int m_min_cluster_size = 1;  // The minimum cluster size
  unsigned long int m_max_cluster_size = 1000;  // The maximum cluster size
